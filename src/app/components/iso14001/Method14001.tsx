...
const bullets = [
  "Aspectos ambientais geram controles operacionais e indicadores",
  "Requisitos legais ficam vinculados a processos e atividades",
  "Não conformidades ambientais abrem ações com rastreabilidade",
  "Metas, emergências e riscos geram ações com origem clara",
];

/* ── Diagram data ── */
const originSources = [
  { label: "Aspectos Ambientais", sub: "Significância identificada", color: "#10B981", bg: "#EEFBF4", border: "#A6E4C4", icon: Leaf },
  { label: "Requisitos Legais", sub: "Obrigação identificada", color: "#EA8C3C", bg: "#FDF5EE", border: "#F5CDA6", icon: FileCheck },
  { label: "Não Conformidades", sub: "Desvio registrado", color: "#DC4545", bg: "#FDF0F0", border: "#F2B8B8", icon: AlertOctagon },
  { label: "Indicadores Ambientais", sub: "Meta fora do esperado", color: "#3B82F6", bg: "#EFF5FF", border: "#B3D1FC", icon: BarChart3 },
  { label: "Objetivos Ambientais", sub: "Desdobramento em execução", color: "#059669", bg: "#EDF7F3", border: "#A8E0C4", icon: Target },
  { label: "Emergências", sub: "Preparação e resposta", color: "#DC2626", bg: "#FEF2F2", border: "#FECACA", icon: ShieldAlert },
  { label: "Resíduos", sub: "Controle e destinação", color: "#7C3AED", bg: "#F5F0FF", border: "#CAB8F8", icon: Trash2 },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 xl:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            >
              Nada fica solto na sua ISO 14001
            </h2>
            ...
            >
              Aspectos ambientais, requisitos legais, não conformidades, indicadores, objetivos e emergências podem gerar ações conectadas, com origem clara, responsável, prazo e acompanhamento.
            </p>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 4px 24px rgba(5,150,105,0.28), 0 1px 4px rgba(5,150,105,0.12)",
      }}
    >
      <p
        style={{
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "#059669", opacity: 0.45 }}
      />
      <span style={{ fontSize: "0.68rem", fontWeight: 560, color: "#14532D" }}>
        {label}
      </span>
    </div>
  );
