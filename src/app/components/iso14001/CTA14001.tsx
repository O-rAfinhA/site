    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ backgroundColor: "#059669", filter: "blur(120px)" }}
        />
        {/* Subtle grid */}
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="ctaGrid14001" width="80" height="80" patternUnits="userSpaceOnUse">
              <path d="M 80 0 L 0 0 0 80" fill="none" stroke="white" strokeWidth="0.5" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#ctaGrid14001)" />
        </svg>
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          Tire a ISO 14001 da planilha e coloque a gestão ambiental{" "}
          <span style={{ color: "#10B981" }}>em um sistema claro e integrado</span>
        </h2>
        ...
        >
          Se a sua empresa precisa de controle real da ISO 14001, com aspectos organizados, legislação monitorada e processos conectados, conheça o SisteQ.
        </p>
        ...
        <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
          {[
            "Sem compromisso",
            "Demo personalizada para ISO 14001",
            "Equipe especializada em gestão ambiental",
          ].map((text) => (
