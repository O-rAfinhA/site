...
const pillars = [
  {
    ...
    items: [
      "Cada ação tem origem rastreável — aspecto, requisito legal ou NC",
  ...
  },
  {
    ...
    subtitle: "Projetado para o gestor ambiental, não para o TI",
    color: "#10B981",
    bg: "rgba(16,185,129,0.08)",
    border: "rgba(16,185,129,0.18)",
    items: [
      "Interface limpa, sem excesso de cliques ou telas complexas",
      "Navegação guiada pelo fluxo natural da gestão ambiental",
  ...
  },
  {
    ...
    subtitle: "Números que orientam decisões ambientais reais",
    color: "#D97706",
    bg: "rgba(217,119,6,0.08)",
    border: "rgba(217,119,6,0.18)",
    items: [
      "Indicadores ambientais e metas consolidados em tempo real",
      "Matriz de aspectos com visualização por significância",
      "Painel de análise crítica com todos os dados em um único lugar",
      "Relatórios automáticos para reuniões de direção",
    ],
    metric: { value: "360°", label: "Visão da gestão ambiental" },
  },
];

export function Pillars14001() {
  return (
    <section
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ backgroundColor: "#059669", filter: "blur(100px)" }}
        />
        <div
          className="absolute bottom-0 left-0 w-64 h-64 rounded-full opacity-5"
          style={{ backgroundColor: "#10B981", filter: "blur(80px)" }}
        />
      </div>
