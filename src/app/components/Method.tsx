...
const bullets = [
  "Auditorias apontam falhas e já direcionam ações",
  "Riscos ficam vinculados ao processo de origem",
  "Indicadores fora da meta podem abrir tratamento",
  "Objetivos, SWOT e não conformidades geram ações com rastreabilidade",
];

/* ── Diagram data ── */
const originSources = [
  { label: "Auditorias", sub: "Achados e desvios identificados", color: "#EA8C3C", bg: "#FDF5EE", border: "#F5CDA6", icon: ClipboardCheck },
  { label: "Riscos", sub: "Tratamento vinculado ao processo", color: "#DC4545", bg: "#FDF0F0", border: "#F2B8B8", icon: ShieldAlert },
  { label: "Indicadores", sub: "Meta fora do esperado", color: "#16A064", bg: "#EEFBF4", border: "#A6E4C4", icon: BarChart3 },
  { label: "Obj. da Qualidade", sub: "Desdobramento em execução", color: "#3B82F6", bg: "#EFF5FF", border: "#B3D1FC", icon: Target },
  { label: "SWOT / Estratégia", sub: "Ação estratégica priorizada", color: "#0F5E7A", bg: "#EDF5F8", border: "#A8D0DE", icon: Compass },
  { label: "Não Conformidades", sub: "Origem e causa registradas", color: "#8B5CF6", bg: "#F5F0FF", border: "#CAB8F8", icon: AlertOctagon },
  { label: "Processos", sub: "Contexto operacional vinculado", color: "#0891B2", bg: "#EEFBFD", border: "#A6E0EB", icon: GitBranch },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 xl:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            >
              Nada fica solto na sua ISO 9001
            </h2>
            ...
            >
              Auditorias, riscos, indicadores, objetivos da qualidade, SWOT, processos e não conformidades podem gerar ações conectadas, com origem clara, responsável, prazo e acompanhamento.
            </p>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 4px 24px rgba(0,75,168,0.28), 0 1px 4px rgba(0,75,168,0.12)",
      }}
    >
      <p
        style={{
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "#004BA8", opacity: 0.45 }}
      />
      <span style={{ fontSize: "0.68rem", fontWeight: 560, color: "#1E3A6E" }}>
        {label}
      </span>
    </div>
  );
