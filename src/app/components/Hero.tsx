    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{ backgroundColor: "#004BA8", filter: "blur(80px)" }}
        />
        <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-8 border border-blue-400/30"
              style={{ backgroundColor: "rgba(0,75,168,0.15)" }}>
            ...
            >
              Mantenha a ISO 9001 sob controle{" "}
              <span style={{ color: "#60A5FA" }}>com processos, auditorias e evidências integradas</span>
            </h1>
            ...
            >
              O SisteQ ajuda empresas em certificação e empresas já certificadas a organizar a rotina da qualidade, acompanhar pendências, centralizar evidências e ter visão clara do sistema de gestão — tudo em um só lugar.
            </p>
    ...
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <span className="text-white/40 text-xs">SisteQ · Painel de Gestão</span>
          <div className="w-16" />
        </div>
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            {[
              { label: "Riscos Monitorados", value: "24", color: "#3B82F6", trend: "↑ 3" },
              { label: "Ações em Andamento", value: "12", color: "#10B981", trend: "↓ 2" },
              { label: "Indicadores OK", value: "18/20", color: "#8B5CF6", trend: "↑ 1" },
            ].map((stat) => (
              <div
                key={stat.label}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              {["Risco", "Plano de Ação", "Indicador", "Análise"].map((item, i) => (
          ...
          <div className="space-y-2">
            {[
              {
                label: "FORN-08 · Avaliação de fornecedor",
                status: "Pendente",
                color: "#F59E0B",
                pct: 45,
              },
              {
                label: "RISK-12 · Fornecedor crítico",
                status: "Monitorado",
                color: "#3B82F6",
                pct: 100,
              },
              {
                label: "IND-07 · Meta de qualidade",
                status: "Atingido",
                color: "#10B981",
                pct: 92,
              },
