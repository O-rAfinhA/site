    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ backgroundColor: "#B45A1C", filter: "blur(120px)" }}
        />
        {/* Subtle grid */}
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="ctaGridPBQPH" width="80" height="80" patternUnits="userSpaceOnUse">
              <path d="M 80 0 L 0 0 0 80" fill="none" stroke="white" strokeWidth="0.5" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#ctaGridPBQPH)" />
        </svg>
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          Tire o PBQP-H da planilha e coloque a gestão de obras{" "}
          <span style={{ color: "#F59E0B" }}>em um sistema claro e integrado</span>
        </h2>
        ...
        >
          Se a sua construtora precisa de controle real do PBQP-H, com RDO organizado, FVS rastreadas e processos conectados, conheça o SisteQ.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            ...
            style={{
              ...
              fontWeight: 600,
              fontSize: "1rem",
              boxShadow: "0 12px 40px rgba(180,90,28,0.45)",
            }}
          >
            <Calendar size={18} />
        ...
        <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
          {[
            "Sem compromisso",
            "Demo personalizada para PBQP-H",
            "Equipe especializada em construção civil",
          ].map((text) => (
