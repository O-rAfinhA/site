    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{ backgroundColor: "#B45A1C", filter: "blur(80px)" }}
        />
        <div
          className="absolute bottom-0 left-0 w-80 h-80 rounded-full opacity-5"
          style={{ backgroundColor: "#D97706", filter: "blur(100px)" }}
        />
        {/* Grid lines */}
        <svg
        ...
        >
          <defs>
            <pattern id="gridPBQPH" width="60" height="60" patternUnits="userSpaceOnUse">
              <path d="M 60 0 L 0 0 0 60" fill="none" stroke="white" strokeWidth="0.5" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#gridPBQPH)" />
        </svg>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-8 border border-orange-400/30"
              style={{ backgroundColor: "rgba(180,90,28,0.15)" }}>
            ...
            >
              PBQP-H sob controle{" "}
              <span style={{ color: "#F59E0B" }}>com obra, RDO, FVS e controle técnico integrados</span>
            </h1>
            ...
            >
              O SisteQ ajuda construtoras a estruturar e manter o PBQP-H, controlando a execução das obras, inspecionado e liberando, acompanhando os controles técnicos e centralizando evidências em um só lugar.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                ...
                style={{
                  ...
                  fontWeight: 600,
                  boxShadow: "0 8px 24px rgba(180,90,28,0.45)",
                }}
              >
    ...
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <span className="text-white/40 text-xs">SisteQ · Gestão de Obras</span>
          <div className="w-16" />
        </div>
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            {[
              { label: "Obras Ativas", value: "8", color: "#F59E0B", trend: "↑ 2" },
              { label: "RDOs Pendentes", value: "3", color: "#EF4444", trend: "→ 0" },
              { label: "FVS em Dia", value: "12/14", color: "#10B981", trend: "↑ 1" },
            ].map((stat) => (
              <div
                key={stat.label}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              {["Obra", "RDO", "FVS", "Controle"].map((item, i) => (
          ...
          <div className="space-y-2">
            {[
              {
                label: "OBRA-03 · Residencial Alto Padrão",
                status: "Andamento",
                color: "#F59E0B",
                pct: 68,
              },
              {
                label: "FVS-08 · Concreto lote 245",
                status: "Aprovado",
                color: "#10B981",
                pct: 100,
              },
              {
                label: "RDO-12 · Dia 28/04/2026",
                status: "Pendente",
                color: "#EF4444",
                pct: 0,
              },
