...
import { ClerkLoaded, ClerkLoading, SignedIn, SignedOut, SignIn } from "@clerk/nextjs";
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          Entre com suas credenciais para acessar a plataforma SisteQ.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section className="py-20 lg:py-28" style={{ backgroundColor: "#F8FAFC" }}>
      <div className="max-w-md mx-auto px-6 lg:px-8 -mt-20 relative z-10">
        <div
          className="rounded-3xl p-8 lg:p-10 shadow-xl"
          style={{
          ...
          <SignedOut>
            ...
            <ClerkLoaded>
              <div className="transition-opacity duration-300">
                <ClerkSignInErrorBoundary fallbackHref={appUrl}>
                  <SignIn
                    routing="hash"
                    signUpUrl="/cadastro"
          ...
          <SignedIn>
            <div className="rounded-2xl border border-slate-200 p-5 text-center transition-all">
              ...
              <p className="mt-2" style={{ fontSize: "0.9rem", color: "#64748B", lineHeight: 1.6 }}>
                Você já está autenticado. Abra o app para continuar.
              </p>
              <a
                href={appUrl}
        ...
        <p
          ...
          style={{ fontSize: "0.8rem", color: "#94A3B8", lineHeight: 1.5 }}
        >
...
class ClerkSignInErrorBoundary extends React.Component<
